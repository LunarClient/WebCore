...
if (MSVC)
    set(AVIF_INCLUDE_DIR "${WEBKIT_LIBRARIES_DIR}/include/avif" CACHE PATH "" FORCE)
    set(AVIF_LIBRARY "${WEBKIT_LIBRARIES_DIR}/lib/avif.lib" CACHE FILEPATH "" FORCE)
else ()
    set(AVIF_INCLUDE_DIR "${WEBKIT_LIBRARIES_DIR}/include/avif" CACHE PATH "" FORCE)
    set(AVIF_LIBRARY "${WEBKIT_LIBRARIES_DIR}/lib/libavif.a" CACHE FILEPATH "" FORCE)
endif ()
file(MAKE_DIRECTORY "${AVIF_INCLUDE_DIR}")
